...
_HARDCODED: Dict[str, Tuple[float, float]] = {
    ...
    # Indic script coastal aliases (Hindi / Gujarati / Tamil / Bengali / Malayalam)
    "दीव":               (20.7141, 70.9889),
    "दमन":               (20.3974, 72.8328),
    "कोच्चि":            (9.9312, 76.2673),
    "कोचीन":             (9.9312, 76.2673),
    "मुंबई":             (18.9388, 72.8354),
    "चेन्नई":            (13.0827, 80.2707),
    "कोलकाता":           (22.5726, 88.3639),
    "विशाखापट्टनम":       (17.6868, 83.2185),
    "गोवा":              (15.4909, 73.8278),
    "पोरबंदर":           (21.6417, 69.6293),
    "वेरावल":            (20.9019, 70.3630),
    "द्वारका":           (22.2394, 68.9679),
    "पुरी":              (19.8135, 85.8312),
    "पारादीप":           (20.3200, 86.6108),
    "पारद्वीप":          (20.3200, 86.6108),
    "मंगलुरु":           (12.8706, 74.8422),
    "मैंगलोर":           (12.8706, 74.8422),
    "दीघा":              (21.6281, 87.5081),
    "रामेश्वरम":         (9.2881, 79.3129),
    "कच्छ":              (23.0333, 70.2167),
    "मांडवी":            (22.8290, 69.3582),
    "ओखा":               (22.4700, 69.0700),
    "रत्नागिरी":         (16.9944, 73.3000),
    "अलीबाग":            (18.6453, 72.8789),
    "कन्नूर":            (11.8745, 75.3704),
    "कोझिकोड":           (11.2588, 75.7804),
    "तिरुवनंतपुरम":      (8.5241, 76.9366),
    "कन्याकुमारी":        (8.0883, 77.5385),
    "कावारत्ती":         (10.5669, 72.6420),
    "पोर्ट ब्लेयर":      (11.6234, 92.7265),
    "अंडमान":            (11.6234, 92.7265),
    "लक्षद्वीप":         (10.5669, 72.6420),
    "सूरत":              (21.1702, 72.8311),
    "सुरत":              (21.1702, 72.8311),
    "भावनगर":            (21.7645, 72.1519),
    "जामनगर":            (22.4707, 70.0577),
    "कांडला":            (23.0333, 70.2167),
    "কেরল":              (9.9312, 76.2673),
    "கொச்சி":            (9.9312, 76.2673),
    "சென்னை":            (13.0827, 80.2707),
    "தூத்துக்குடி":        (8.7642, 78.1348),
    "கன்னியாகுமரி":       (8.0883, 77.5385),
    "ராமேஸ்வரம்":         (9.2881, 79.3129),
    "மங்களூரு":          (12.8706, 74.8422),
    "விசாகப்பட்டினம்":    (17.6868, 83.2185),
    "പോർബന്ദർ":          (21.6417, 69.6293),
    "കൊയിലാണ്ടി":        (11.4333, 75.7000),
}
...
def resolve_location(query: str) -> Dict[str, Any]:
    ...
    tokens = [w for w in re.findall(r'\b\w+\b', query, re.UNICODE) if w.lower() not in _STOP_WORDS]
    if not tokens:
