...
cmems_client.py
---------------
Marine conditions client for Milestone 2.
...
The module name 'cmems_client' is preserved from Milestone 1 to avoid
import-chain changes.  If CMEMS credentials become available in future,
the client can be upgraded here without touching any agent code.
...
logger = logging.getLogger("tarang.cmems")
