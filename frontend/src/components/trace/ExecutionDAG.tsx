...
const DAG_NODES: DAGNode[] = [
  ...
  },
  {
    id: "sst_agent",
    name: "sst_agent",
    label: "Sea Surface Temperature Agent",
    category: "specialist",
    icon: Thermometer,
    description: "Queries daily SST and thermal anomalies from INCOIS ERDDAP without API keys. Temperature indicator only; does not guarantee fish.",
    sourceDefault: "INCOIS ERDDAP (NOAA AVHRR/AMSR SST)",
    tier: "Tier 1: INCOIS ERDDAP",
    readsFrom: ["resolved_location"],
    writesTo: ["sst_result"],
  },
  {
